...
<body class="font-sans antialiased text-gray-900 bg-gray-50 overflow-hidden" style="font-family: 'Poppins', sans-serif;">
    ...
    @if (session('success'))
        <div x-data="{ show: true }"
            ...
            <button @click="show = false" type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 transition-colors">
